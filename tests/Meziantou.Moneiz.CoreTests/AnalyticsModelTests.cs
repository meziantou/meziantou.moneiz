...
public sealed class AnalyticsModelTests
{
    ...
    public void ComputeModel()
    {
        ...
        {
            Account = account,
            ValueDate = new System.DateOnly(2023, 6, 1),
            Amount = 1,
        });
        ...
        {
            Account = account,
            ValueDate = new System.DateOnly(2023, 6, 3),
            Amount = 3,
        });
        ...
        {
            Account = account,
            ValueDate = new System.DateOnly(2023, 6, 4),
            Amount = 4,
        });
        ...
        {
            Account = account,
            ValueDate = new System.DateOnly(2023, 6, 5),
            Amount = 5,
        });

        var result = AnalyticsModel.Build(database, new AnalyticsOptions
        {
            FromDate = new System.DateOnly(2023, 6, 3),
            ToDate = new System.DateOnly(2023, 6, 4),
